...
@section('content')
    ...
    <section class="section">
        <div class="section-header">
            <h1>Form Pengajuan Seminar Hasil</h1>
        </div>
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group row mb-4">
                                <label class="col-form-label text-md-right col-12 col-md-3 col-lg-3">Pengajuan
                                    Seminar</label>
                                <div class="col-sm-12 col-md-7">
                                    <input type="text" class="form-control" placeholder="Seminar Hasil" disabled>
                                </div>
                            </div>

                            <div class="form-group row mb-4">
                                <label class="col-form-label text-md-right col-12 col-md-3 col-lg-3">Draft Laporan
                                    Skripsi</label>
                                <div class="col-sm-12 col-md-7">
                                    @if ($topic->kemajuan_IV == null)
                                        <div class="form-control">Belum Mengunggah Kemajuan IV</div>
                                    @else
